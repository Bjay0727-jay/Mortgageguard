...
import { evidencePacketRoutes } from "./routes/evidence-packets";
...
app.route("/api/v1/regulatory-sources", regulatorySourceRoutes);
app.route("/api/v1/reports", reportRoutes);
app.route("/api/v1/evidence-packets", evidencePacketRoutes);
app.route("/api/v1/outbox", outboxRoutes);
